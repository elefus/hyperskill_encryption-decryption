class TestDrive {
    ...
    public static void main(String[] args) throws InterruptedException {
        LaptopFactory laptopFactory = new LaptopStore();

        Laptop laptop13 = laptopFactory.orderLaptop("13 inch");
        Laptop laptop15 = laptopFactory.orderLaptop("15 inch");
        Laptop laptop17 = laptopFactory.orderLaptop("17 inch");
